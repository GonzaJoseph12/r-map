...
//                     children: [
//                       SizedBox(width: 10),
//                       Icon(Icons.currency_bitcoin_sharp, size: 40),
//                       Text('500'), //ARGECLAR TAMAÑO TEXTO
//                     ],
//                   ),
//                 ),
...
//                                 ),
//                                 Text(
//                                   "Revisa tus puntos por\nreciclar en los lugares cercanos",
//                                   style: TextStyle(
//                                       fontSize: 13, color: Colors.black),
//                                 ),
//                                 SizedBox(
...
//                                       left: 0.0,
//                                       top:
//                                           5), // Agrega el margen a la izquierda
//                                   child: Text(
...
//                                   padding: EdgeInsets.only(
//                                       left:
//                                           90.0), // Agrega el margen a la izquierda
//                                   child: Text(
...
//     },
//     child: Container(
//       width: 220, // Ajusta el ancho del botón según tus necesidades
//       height: 50, // Ajusta el alto del botón según tus necesidades
//       decoration: BoxDecoration(
